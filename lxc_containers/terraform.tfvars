# --- Proxmox connection ---
pve_api_url      = "https://xxxx.17:8006"
pve_api_token    = "xxxxxx"
...
# --- Networking ---
ct_bridge = "vmbr0"
#ct_ipv4_cidr            = "xxxx.62/24"
ct_gateway             = "xxxx.1"
ct_dns_domain          = "domain name"
ct_dns_server          = "xxxx.1"
...
lxcs = {
  ...
  ICARUS = {
    vmid         = 500
    hostname     = "icarus.techlab.local"
    ipv4_cidr    = "xxxx.37/24"
    cores        = 1
    memory_mb    = 1024
    disk_size_gb = "50"
  }
